    ...
    <header className="relative w-full min-h-[90vh] flex flex-col items-center justify-center pt-24 overflow-hidden">
      ...
      <div className="absolute inset-0 z-0 pointer-events-auto opacity-100 overflow-hidden">
        <iframe 
          ...
          frameBorder="0" 
          title="3D Content"
          className="pointer-events-auto absolute top-0 left-0 w-[320%] h-[320%] scale-[0.33] md:w-[200%] md:h-[200%] md:scale-50 origin-top-left"
        ></iframe>
      </div>

      {/* Dark Mode Overlay */}
      <div className="absolute inset-0 z-[1] pointer-events-none transition-colors duration-300 dark:bg-black/70"></div>
      ...
      <div className="relative z-10 text-center px-4 max-w-5xl mx-auto pointer-events-none mt-0">
        ...
        <h1 className="font-bold text-4xl sm:text-5xl md:text-7xl lg:text-8xl text-brand-dark dark:text-brand-cream leading-[1.1] tracking-tight mb-8 drop-shadow-sm break-keep transition-colors duration-300">
